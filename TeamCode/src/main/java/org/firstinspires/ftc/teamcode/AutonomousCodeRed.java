...
@Config
@Autonomous(group = "RED ALLIANCE AUTO")
public class AutonomousCodeRed extends OpMode {
    ...
    private final Pose startPose = new Pose(125.5, 36, Math.toRadians(90));

    /** Scoring Pose of our robot.  */
    private final Pose scorePose = new Pose(131.5, 13, Math.toRadians(135));

    /** Middle  Sample from the Spike Mark */
    private final Pose pickup1Pose = new Pose(110.5, 13, Math.toRadians(180));

    /** Upper  Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(110.5, 23.5, Math.toRadians(0));


    /** Park Pose for our robot, after we do all of the scoring. */
    private final Pose parkPose = new Pose(135, 118, Math.toRadians(90));
